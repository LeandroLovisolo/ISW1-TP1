...
\begin{multicols}{2}
  \begin{itemize}
    ...
    \item Personal de empresa de transporte informa su ubicación (No va)
    \item Personal de empresa de transporte informa si tiene lugar para cargar mas bicicletas (No)
    \item Personal de empresa de transporte informa si estan transportando bicicletas o no (No)
    \item Personal de estación informa al sistema que tiene una bicicleta menos 
    \item Personal de estación informa al sistema que tiene una bicicleta más
    \item Personal de estación solicita reposición de bicis   
    \item Personal de estación informa que un usuario tiene una bici en su poder
    \item Personal de estación informa que un usuario ya no tiene ninguna bici en su poder
    \item Personal de estación informa robo de una bici
    \item Personal de estación checkea en el sistema si un usuario existe
    \item Personal de estación checkea en el sistema si un usuario puede retirar una bicicleta
...
\begin{multicols}{2}
  \begin{itemize}
    ...
    \item Sistema calcula mediante un algoritmo que estación es la mas indicada para ceder bicicletas según la distancia entre las estaciones y la ubicación actual de los camiones (No se sabe ubicación, no va)
    \item Sistema averigua donde se encuentran los camiones (No va)
    \item Sistema averigua si un camion tiene lugar para cargar bicicletas (No va)
    \item Sistema averigua si un camion esta transportando bicicletas o no (No va)
  \end{itemize}
\end{multicols}
